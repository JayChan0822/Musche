...

{
    ...
    assert.equal(feature.dateTransitionName.value, 'slide-next', 'smart task scrolling should use the slide direction matching the date move (forward → next) for direction feedback');
