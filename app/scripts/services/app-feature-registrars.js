...
export function createAppFeatureRegistrars({ pinyinMatchSupport } = {}) {
    return {
        ...
        registerSessionFeature: createSessionFeatureRegistrar(),
        registerHistoryFeature: createHistoryFeatureRegistrar(),
        registerRatioFeature: createRatioFeatureRegistrar(),
        registerNameLookupFeature: createNameLookupFeatureRegistrar(),
        registerSplitViewFeature: createSplitViewFeatureRegistrar(),
        registerDropdownsFeature: createDropdownsFeatureRegistrar(),
        registerViewNavigationFeature: createViewNavigationFeatureRegistrar(),
        registerQuickAddFeature: createQuickAddFeatureRegistrar(),
        registerUniversalModalFeature: createUniversalModalFeatureRegistrar(),
        registerOrchestrationFeature: createOrchestrationFeatureRegistrar(),
        registerSplitTaskFeature: createSplitTaskFeatureRegistrar(),
        registerPickerControlsFeature: createPickerControlsFeatureRegistrar(),
        registerPoolInteractionsFeature: createPoolInteractionsFeatureRegistrar(),
        registerSearchFeature: createSearchFeatureRegistrar({ pinyinMatchSupport }),
        registerSidebarStatsFeature: createSidebarStatsFeatureRegistrar(),
        registerSidebarFeature: createSidebarFeatureRegistrar(),
        registerMobileUiFeature: createMobileUiFeatureRegistrar(),
        registerScheduleFeature: createScheduleFeatureRegistrar(),
        ...
        registerSettingsSyncFeature: createSettingsSyncFeatureRegistrar(),
    };
}
