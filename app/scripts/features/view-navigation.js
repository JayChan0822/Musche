...
export function registerViewNavigationFeature(context) {
  ...
  return {
    ...
    openDayView: calendarViewFeature.openDayView,
    closeDayView: calendarViewFeature.closeDayView,
    changeSelectedDay: calendarViewFeature.changeSelectedDay,
    selectedDayWeek: calendarViewFeature.selectedDayWeek,
    selectedDayTasks: calendarViewFeature.selectedDayTasks,
    selectedDayLabel: calendarViewFeature.selectedDayLabel,
    dayViewTouchStart: calendarViewFeature.dayViewTouchStart,
    dayViewTouchMove: calendarViewFeature.dayViewTouchMove,
    dayViewTouchEnd: calendarViewFeature.dayViewTouchEnd,
